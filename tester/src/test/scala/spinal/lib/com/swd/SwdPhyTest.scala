...
/**
 * Run: sbt "tester/testOnly spinal.lib.com.swd.SwdPhyTest"
 */
class SwdPhyTest extends SpinalAnyFunSuite {
  ...
  class Harness(val dut: SwdPhy) {
    ...
    val drv = new SwdHostDriver(cd, dut.io.swdio)
